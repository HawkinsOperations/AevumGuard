...
* `case_growth`: aggregates seven expected repo slots into numeric JSON and Markdown, reports repo-slot accuracy, and derives Case Growth Health without promoting proof beyond repo authority.
